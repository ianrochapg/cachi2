...
class PipRequirement:
    ...
    def copy(
        ...
        # the URL, clear them.
        requirement.extras = set() if url else set(self.extras)
    ...
    def from_line(cls, line: str, options: list[str]) -> "PipRequirement":
        ...
        if direct_access_kind:
            if direct_access_kind in ["url", "vcs"]:
                requirement.kind = cast(Literal["pypi", "url", "vcs"], direct_access_kind)
    ...
    @staticmethod
    def _assess_direct_access_requirement(line: str) -> str:
